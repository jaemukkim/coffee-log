...
> **"데이터로 마시는 스마트한 홈카페 기록장"** > 커피 머신 사용자를 위한 맞춤형 캡슐 재고 관리 및 소비 분석 웹 서비스입니다.

---

## 🚀 주요 기능 (Key Features)

### 1️⃣ 실시간 재고 관리 및 스마트 퀵 기록
...
### 2️⃣ 데이터 기반 대시보드 & 시각화 (Plotly & Pandas 활용)
...
### 3️⃣ 사용자 맞춤형 가이드
* **기기 최적화 가이드**: 사용자인 일리 Y3.3 머신의 특성을 고려한 권장 추출 시간(25~28초) 가이드를 제공하여 일관된 커피 맛을 유지하도록 돕습니다.
